      ...
      <div className="section__inner">
        ...
        <div className="datenschutz__content animate" style={{ animationDelay: "0.25s" }}>
          ...
          <p>
            ...
            personenbezogenen Daten (im Folgenden „Daten") auf dieser Website auf.
          </p>

          <h2>2. Allgemeine Hinweise</h2>
          <p>
            Die Betreiber dieser Website nehmen den Schutz Ihrer persönlichen Daten ernst. Wir behandeln
          ...
          <p>
            ...
            Erklärung hilft Ihnen zu verstehen, welche Daten wir sammeln und wofür wir sie nutzen.
          </p>
          ...
          <p>
            ...
            <br />
            <a href="tel:+4915150100352">0151 / 50100352</a>
            <br />
          ...
          <h2>5. Google Maps</h2>
          <p>
            Diese Website nutzt Google Maps zur Anzeige von Kartenmaterial. Bei der Nutzung von Google
            Maps werden von Google auch Daten über die Nutzung der Kartenfunktionen durch Besucher
            erfasst, verarbeitet und genutzt. Weitere Informationen über die Datenverarbeitung durch
            Google erhalten Sie in der{" "}
          ...
          <ul>
            <li>
              <strong>Auskunft:</strong> Sie können Auskunft über die zu Ihrer Person gespeicherten Daten
              verlangen.
            </li>
            <li>
              <strong>Berichtigung:</strong> Sie können die Berichtigung unrichtiger oder unvollständiger
              Daten verlangen.
            </li>
            <li>
            ...
            <li>
              <strong>Widerspruch:</strong> Sie können gegen die Verarbeitung Ihrer Daten Widerspruch
              einlegen.
            </li>
          </ul>
          ...
          <p>
            Wir behalten uns vor, diese Datenschutzerklärung anzupassen, damit sie jederzeit den aktuellen
            gesetzlichen Anforderungen entspricht. Die Datenschutzerklärung wird regelmäßig überprüft und
            ggfs. aktualisiert.
          </p>
